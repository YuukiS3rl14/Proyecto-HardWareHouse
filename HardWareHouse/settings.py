"""
Django settings for HardWareHouse project.
...
ROOT_URLCONF = 'HardWareHouse.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.extras_context', # Añadido para contadores globales
            ],
        },
    },
]

WSGI_APPLICATION = 'HardWareHouse.wsgi.application'
